...
<?php do_action( 'wp_body_open' ); ?>
	...
	<div id="page" class="site">
					...
					<div class="col-xs-12 col-sm-6 col-md-5">
						<div class="top-header-right">
							...
							<?php if( !business_consultr_get_option( 'disable_search_icon' ) ):?>
									<span class="search-icon" style="text-align: right;">
										<a href="#">
		...
		?>
		<header id="masthead" class="wrapper site-header" role="banner" style="padding-bottom: 0px; padding-top: 0px;">
			<div class="container"style="">
				<div class="row">
					...
					<?php $class = ''; ?>
					<?php !business_consultr_get_option( 'disable_header_button' ) ? $class = 'col-md-6' : $class = 'col-md-9'; ?>
